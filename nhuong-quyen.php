            ...
            <ul>
                ...
                <li data-index="rs-3" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/slide-img2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="rs-background-video-layer"
                         ...
                         data-videomp4="video/video3.mp4"
        ...
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 col-md-7 col-sm-7 text-sm-left text-center wow fadeInLeft" data-wow-delay="300ms">
                <div class="heading-title mb-4">
                    <h2 class="darkcolor font-normal bottom30">Tại sao là Ryn Ryn?</h2>
                </div>
                <ul class="why-us-list">
                   <li> Thấu hiểu khách hàng trẻ tuổi</li>
                   <li> Thiết kế trẻ trung- trending</li>
                   <li> Đồ uống đã được khẳng định</li>
                   <li> Công thức pha chế chuẩn hoá</li>
                   <li> Hoàn vốn nhanh- Chi phí thấp</li>
                   <li> Vận hành chuyên nghiệp</li>
                   <li> Được đào tạo và Testing kĩ năng 100%</li>
                   <li> Cơ hội thành đại lý độc quyền khu vực</li>
                </ul>
            </div>
                 ...
                 <form class="getin_form border-form" id="register">
                    <div class="row">
                       ...
                       <div class="col-md-12 col-sm-12">
                        ...
                        <div class="input-group  bottom35">
                            <select class="custom-select " required id="registerPrice">
                                <option selected>Khu vực tỉnh/thành?</option>
                                <option value="HCM">Hồ Chí Minh
